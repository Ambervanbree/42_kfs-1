...
void init_screen_if_needed(int n){
    ...
    if (n == 0) {
        ...
        current_color = vga_color(VGA_COLOR_BLUE, VGA_COLOR_BLACK);
    } else if (n == 2) {
        current_color = vga_color(VGA_COLOR_RED, VGA_COLOR_BLACK);
    }
